...
The first thing you want to do with this repo is quite likely **[fork it](https://github.com/verdematics/oreilly-github-demo)**.  Use the Fork button in the top-right section of the page to do this.
